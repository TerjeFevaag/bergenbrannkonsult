...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://www.bergenbrannkonsult.no/branntilsyn' },
}
            ...
            <div className="lg:w-[65%]">
              <ScrollReveal>
                <p className="text-brand-darkgray text-lg leading-relaxed mb-8">
                  Har kommunen vært på branntilsyn, eller ønsker du å kartlegge brannsikkerheten i en eldre bygning i Bergen? Vi hjelper borettslag, sameier, næringsbygg og eiendomseiere med branninspeksjon og vurdering av byggets brannsikkerhet.
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal>
                ...
                <p className="text-brand-darkgray leading-relaxed mb-8">
                  Alle bygninger i Norge skal tilfredsstille et minimum brannsikkerhetsnivå tilsvarende det som gjaldt for nybygg i 1985 (BF85). Eldre bygg som ikke oppfyller dette kravet skal utbedres. Bergen har mange verneverdige og eldre bygninger som kan ha behov for branntekniske tiltak.
                </p>
              </ScrollReveal>
              ...
              <ScrollReveal delay={200}>
                <div className="sticky top-24">
                  <div className="bg-brand-dark rounded-[30px] p-8 text-brand-white">
                    <h3 className="font-bold text-xl mb-3">Fått pålegg?</h3>
