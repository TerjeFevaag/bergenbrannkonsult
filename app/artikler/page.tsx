...
export const metadata: Metadata = {
  ...
  description:
    'Nyttige artikler om brannsikkerhet fra sentralt godkjente brannrådgivere. Les om pipebrann, brannslokkeapparat, røykvarslere og mer.',
  alternates: { canonical: 'https://www.bergenbrannkonsult.no/artikler' },
}
...
const articles = [
  {
    ...
    excerpt: 'Er du i faresonen for å kunne få brann i skorsteinen? Les om hva som forårsaker pipebrann og enkle tiltak for å redusere risikoen.',
  },
  {
    href: '/artikler/brannslokker',
    image: '/images/article-brannslukker.jpg',
    title: 'Har du riktig brannslokkeapparat?',
    excerpt: 'Vet du hvilken type brannslokker du trenger i hjemmet? Vi gjennomgår krav og forskjellen mellom pulver- og skumapparater.',
  },
  {
    href: '/artikler/roykvarsler',
    image: '/images/article-roykvarsler.jpg',
    title: 'Riktig røykvarsler redder liv',
    excerpt: 'Er du godt nok sikret hvis det oppstår brann om natten? Vi forklarer krav til røykvarslere og riktig plassering.',
  },
]
    ...
    <>
      ...
      <section className="bg-brand-dark py-16 lg:py-24">
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-brand-orange text-sm mb-4">
            <Link href="/" className="hover:underline">Hjem</Link>
            <span>/</span>
            <span>Artikler</span>
          </div>
          <h1 className="text-brand-white text-4xl lg:text-5xl font-black max-w-2xl">
            Artikler om brannsikkerhet
          </h1>
          <p className="text-brand-white/70 text-lg mt-4 max-w-xl leading-relaxed">
            Nyttige råd og informasjon fra sentralt godkjente brannrådgivere.
          </p>
        </div>
      </section>
