...
export const metadata: Metadata = {
  title: 'Riktig røykvarsler redder liv | Bergen Brannkonsult',
  description:
    'Krav til røykvarslere i norske boliger, forskjell mellom ionisasjon og optisk varsler, og anbefalt plassering. Råd fra sentralt godkjente brannrådgivere i Bergen.',
  alternates: { canonical: 'https://www.bergenbrannkonsult.no/artikler/roykvarsler' },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Riktig røykvarsler', item: 'https://www.bergenbrannkonsult.no/artikler/roykvarsler' },
  ],
}
            ...
            <div className="prose prose-lg max-w-none text-brand-darkgray">
              ...
              <ScrollReveal>
                <div className="bg-brand-lightgray rounded-[20px] p-6 mb-8">
                  <h3 className="font-bold text-brand-black text-lg mb-3">Anbefaling fra Bergen Brannkonsult</h3>
              ...
              <ScrollReveal>
                ...
                <p className="leading-relaxed">
                  Trenger du brannteknisk vurdering av en eiendom i Bergen?{' '}
                  <Link href="/kontakt-oss" className="text-brand-orange font-bold hover:underline">
                    Ta kontakt med Bergen Brannkonsult
                  </Link>{' '}
