...
export const metadata: Metadata = {
  title: 'Har du riktig brannslokkeapparat? | Bergen Brannkonsult',
  description:
    'Hvilken type brannslokker trenger du? Vi gjennomgår krav til brannslokking i boliger, forskjellen mellom pulver og skum, og riktig bruk. Råd fra Bergen Brannkonsult.',
  alternates: { canonical: 'https://www.bergenbrannkonsult.no/artikler/brannslokker' },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 3, name: 'Riktig brannslokker', item: 'https://www.bergenbrannkonsult.no/artikler/brannslokker' },
  ],
}
